...
export default function ConnectWearableScreen({ navigation, route }) {
  ...
  return (
    <Animated.View entering={FadeIn.duration(300)} style={styles.container}>
      {!showSuccess ? (
        <>
          <Text style={styles.text}>Searching for wearable device...</Text>
          <LottieView
        ...
        <>
          <Image
            ...
            resizeMode="contain"
          />
          <Text style={styles.successText}>Wearable Connected!</Text>
        </>
      )}
    </Animated.View>
  );
